          ...
          <div className="grid md:grid-cols-[60%,40%] gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-black text-md font-serif mb-4">
                ...
                expertise extends to being an Obstetrician as well as a renowned
                specialist in NDVH (Non-Descent Vaginal Hysterectomy) and vNOTE
                (Vaginal Natural Orifice Transluminal Endoscopic Surgery)
                Hysterectomy techniques. With a dedication to providing
                exceptional care, Dr. Kanade combines his surgical precision
                with a compassionate approach to address the diverse needs of
                his patients.
              </p>
