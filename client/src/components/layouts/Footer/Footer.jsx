export default function Footer() {
    return (
        <footer
        className="bg-black text-center text-white dark:bg-white dark:text-white lg:text-left">
        <div
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="">
              <h6
                className="mb-4 flex flex-col items-center justify-center font-semibold uppercase md:justify-start gap-2">
                 <img
                        src="src/assets/logo.jpeg" // Replace with your logo URL
                        alt="Logo"
                        className="h-32"
                    />
                <h2 className="font-semibold text-xl">Kanade Hospital</h2> 
